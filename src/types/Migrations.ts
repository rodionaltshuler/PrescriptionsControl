    ...
    public setCompleted = Object.assign(
        ...
        },
        {
            ...
            estimateGas: (completed: BigNumber | number): Promise<number> => {
                return new Promise((resolve, reject) => {
                    this._instance.setCompleted.estimateGas(completed).then((g: any) => resolve(g)).catch((err: any) => reject(err));
                });
            }
        });
    ...
    public upgrade = Object.assign(
        ...
        },
        {
            ...
            estimateGas: (new_address: string): Promise<number> => {
                return new Promise((resolve, reject) => {
                    this._instance.upgrade.estimateGas(new_address).then((g: any) => resolve(g)).catch((err: any) => reject(err));
                });
            }
        });
